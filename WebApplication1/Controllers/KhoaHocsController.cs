...
namespace WebApplication1.Controllers
{
    public class KhoaHocsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MaKhoaHoc,MonHoc,TieuDe,DuongDanAnhKhoaHoc,MoTa,ThoiHan,MaGiaoVien,NgayCapNhat")] KhoaHoc khoaHoc, IFormFile AnhKhoaHoc)
        {
